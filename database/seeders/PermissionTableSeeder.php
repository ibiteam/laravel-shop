...
class PermissionTableSeeder extends Seeder
{
    ...
    private function addSetPermission(): void
    {
        ...
        $this->addPermission('app广告', Permission::MANAGE_APP_ADVERT_INDEX, 1, Permission::IS_LEFT_NAV, '', Permission::ADVERT_MANAGE);
        $this->addPermission('app广告新增|编辑', Permission::MANAGE_APP_ADVERT_UPDATE, 1, Permission::NOT_IS_LEFT_NAV, '', Permission::ADVERT_MANAGE);
        $this->addPermission('app广告删除', Permission::MANAGE_APP_ADVERT_DELETE, 1, Permission::NOT_IS_LEFT_NAV, '', Permission::ADVERT_MANAGE);
    }
