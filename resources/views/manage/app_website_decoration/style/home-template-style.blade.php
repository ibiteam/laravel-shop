<style>
    ...
    @font-face {
        ...
        src: url('//at.alicdn.com/t/c/font_2575177_zrdo2lh8g1.eot?t=1694595699831'); /* IE9 */
        src: url('//at.alicdn.com/t/c/font_2575177_zrdo2lh8g1.eot?t=1694595699831#iefix') format('embedded-opentype'), /* IE6-IE8 */
        url('//at.alicdn.com/t/c/font_2575177_zrdo2lh8g1.woff2?t=1694595699831') format('woff2'),
        url('//at.alicdn.com/t/c/font_2575177_zrdo2lh8g1.woff?t=1694595699831') format('woff'),
        url('//at.alicdn.com/t/c/font_2575177_zrdo2lh8g1.ttf?t=1694595699831') format('truetype'),
        url('//at.alicdn.com/t/c/font_2575177_zrdo2lh8g1.svg?t=1694595699831#iconfont') format('svg');
    }
    ...
    /*Content*/
    .template-content { width: 260px; }
    /*Source*/
    .template-source-switch { width: 36px; height: 66px; padding: 10px;box-sizing: border-box; background-color: #FFFFFF; box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.1); border-radius: 0px 10px 10px 0px; transition: top 0.1s ease; position: absolute; right: -36px; top: 50px; cursor: pointer; }
    .nav-switch { height: 105px; }
    .nav-switch p{ line-height: 1.2;}
    .template-source-switch p { margin-bottom: 4px; }
    .template-source-switch p,
    .template-source-switch em { font-size: 14px; color: #5D7A98; }
    /* .template-source-switch:hover p,
    .template-source-switch:hover em { color: #409EFF; } */
    .template-content-source { width: 260px; height: calc(100% - 60px); border-bottom-left-radius: 20px; transition: all 0.2s ease; position: fixed; left: 0; top: 60px; z-index: 9999; }
    .check-item { width: 33.33%; height: 50px; line-height: 48px; text-align: center; box-sizing: border-box; background: linear-gradient(0deg, #F9F9F9, #EEEEEE); border: 1px solid #EEEEEE; border-radius: 10px 10px 0px 0px; font-size: 14px; font-weight: 600; cursor: pointer; }
    .check-item.active,
    ...
    .template-content-warning p { margin-left: 6px; font-size: 10px; color: #333333; }
    .template-content-text { width: 100%; height: 66px; line-height: 66px; text-align: center; background: linear-gradient( 270deg, #336EF5 0%, #4E80F3 89%); font-size: 14px; color: #fff; }
    ...
    .template-group-icon dl dd .template-group-list { padding: 0 12.5px; margin-top: 20px; }
    .template-group-icon dl dd .template-icon-list { width: 104px; margin-bottom: 10px; position: relative; }
    .template-group-icon dl dd .template-icon-list.disabled::before { content: '\5df2\8fbe\6dfb\52a0\4e0a\9650'; white-space: nowrap; width: 100%; height: 15px; line-height: 1.6; text-align: center; background-color: rgba(0, 0, 0, 0.4);border-radius: 0px 0px 4px 4px; font-size: 10px; color: #ffffff; box-sizing: border-box; position: absolute; left: 0; bottom: 0; cursor: not-allowed; }
    .template-group-icon dl dd .template-icon-list > div { width: 104px; height: 40px; background-color: #F5F7FB; border: 1px solid #E0E4EF; cursor: grab; box-sizing: border-box; padding-left: 10px; border-radius: 4px;}
    .template-group-icon dl dd .template-icon-list > div em { font-size: 14px; width: 20px; height: 20px; line-height: 20px; text-align: center;}
    .template-group-icon dl dd .template-icon-list > div p { text-align: center; margin-left: 6px; font-size: 12px; }
    /*Tree*/
    .template-content-box { height: calc(100vh - 60px); background-color: #ffffff; box-shadow: 0px 0px 10px 0px rgb(0 0 0 / 10%); }
    .template-group { height: calc(100% - 50px); overflow-y: auto; /*background-color: #F0F8FF;*/ }
    ...
    .template-group-parent .template-group-list .list-item { width: 100px; margin-bottom: 10px; cursor: grab; position: relative; }
    ...
    /*Editor Area*/
    .temp-drag-perview { /*width: 100%;*/ width: 1000px; /*height: calc(100vh - 226px - 98px - 100px);*/ padding: 0 0 20px 0; margin: 0 auto; position: relative; overflow-y: auto; overflow-x: hidden; }
    .temp-drag-perview .temp-not-nest { width: 750px; margin: 0 auto; /*padding-bottom: 30px;*/ position: relative; }
    .temp-drag-perview .temp-not-nest.custom-width { width: auto; max-width: 1920px; }
    .temp-drag-perview .temp-item { border: 2px dashed #409EFF; margin-bottom: 14px; position: relative; }
    .temp-drag-perview .temp-item.default { width: 750px; min-height: 300px; margin: 0 auto 30px auto; cursor: move; position: relative; }
    .temp-drag-perview .temp-item.drag { border: 2px dashed #409EFF; }
    .temp-drag-perview .temp-item.active { /*margin-top: 115px !important;*/ /*margin-top: 80px !important;*/ border: 2px dashed #409EFF; }
    .temp-drag-perview .temp-item.disabled { border-color: #999999; }
    .temp-drag-perview .temp-item.temp-drag-free { height: 500px; }
    /*.temp-drag-perview .temp-item.temp-item-custom { margin-top: 20px; }*/
    .temp-drag-perview .temp-item.temp-item-custom.default { min-height: 402px; }
    .temp-drag-perview .temp-item.item-custom-four.default { min-height: 346px; }
    .temp-drag-perview .temp-item.item-custom-five.default { min-height: 300px; }
    .temp-drag-perview .temp-item.temp-act-countdown { min-height: 200px; margin-top: 20px; }
    .temp-drag-perview .temp-error { position: relative; }
    .temp-drag-perview .temp-error .temp-item-nodata { color: #ffffff; }
    .temp-drag-perview .temp-error::before { content: '\57fa\7840\7ec4\4ef6\4e0d\652f\6301\4e0e\5f53\524d\7ec4\4ef6\53e0\52a0'; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center; border: 2px dashed #EA0808; background-color: rgba(255, 255, 255, 0.9); font-size: 28px; color: #EA0808; position: absolute; left: 0; top: 0; z-index: 999; }
    .temp-drag-perview .temp-item.sortable-chosen { border: 2px dashed #409EFF; }
    .temp-drag-perview .temp-item.error { border: 2px dashed #EA0808; }
    .temp-drag-perview .temp-item .temp-item-child { width: 100%; height: 100%; position: absolute; left: 0; top: 0; }
    .temp-drag-perview .temp-item .temp-item-child .temp-item-content { height: 100%; padding: 26px 28px; box-sizing: border-box; position: relative; }
    .temp-drag-perview .temp-item .temp-item-child .temp-item-content .temp-item-href { width: 100%; height: 100%; position: absolute; left: 0; top: 0; }
    .temp-drag-perview .temp-item-text { width: 100%; height: 100%; line-height: 26px; text-align: center; outline: none; border: none; resize: none; -webkit-user-modify: read-write-plaintext-only; background-color: transparent; cursor: text; font-size: 12px; }
    /*模板头部设置*/
    .temp-drag-perview .temp-item .temp-item-setting { width: 100%; height: 70px; position: absolute; left: 50%; top: -86px; transform: translate(-50%); }
    .temp-drag-perview .temp-item .temp-item-setting::before { content: ''; width: 0; height: 0; border-left: 25px solid transparent; border-right: 25px solid transparent; border-top: 20px solid #E4E7EE; position: absolute; left: 50%; bottom: -10px; transform: translate(-50%); }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box { width: 100%; /*height: 50px;*/ padding: 0 20px; background-color: #E4E7EE; box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.15); border-radius: 8px; box-sizing: border-box; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-btns,
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-show { padding: 12px 0; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .btn,
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .btn:active { width: 60px; height: 34px; padding: 0; margin-right: 10px; line-height: 32px; text-align: center; background-color: #ffffff; box-shadow: none; color: #333333; border: 1px solid #CCCCCC; border-radius: 4px; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .btn.disabled { background-color: #F2F2F2 !important; border-color: #F2F2F2 !important; color: #999999 !important; cursor: not-allowed; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .btn:hover { color: #409EFF; border-color: #c6e2ff; background-color: #ecf5ff; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .btn.primary { margin-left: 24px; background-color: #409EFF; border-color: #409EFF; color: #ffffff; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-name { padding: 5px 0; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-name-center { position: absolute; left: 50%; transform: translate(-50%); }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-name .temp-setting-input { width: 180px; height: 28px; line-height: 26px; text-align: center; border: 1px solid #E4E7EE; font-size: 16px; font-weight: 600; overflow: hidden; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-name input { width: 99%; height: 100%; line-height: 26px; padding: 0 8px; text-align: center; background-color: #E4E7EE; font-size: 16px; font-weight: 600; border: none; outline: none; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-name p { margin-top: 5px; text-align: center; font-size: 12px; color: #777777; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-show { margin-left: 20px; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-show p { margin-top: 6px; font-size: 12px; color: #333333; }
    .temp-drag-perview .temp-item .temp-item-setting.active .temp-setting-box { background-color: #ffffff; }
    .temp-drag-perview .temp-item .temp-item-setting.active::before { border-top: 20px solid #ffffff; }
    .temp-drag-perview .temp-item .temp-item-setting.active .temp-setting-box .temp-setting-name .temp-setting-input,
    .temp-drag-perview .temp-item .temp-item-setting.active .temp-setting-box .temp-setting-name input { background-color: #ffffff; border-color: #ffffff; }
    .temp-drag-perview .temp-item .temp-item-setting .temp-setting-box .temp-setting-name .temp-setting-input.active,
    .temp-drag-perview .temp-item .temp-item-setting.active .temp-setting-box .temp-setting-name div.active { border: 1px solid #409EFF; border-radius: 4px; }
    /*文本字体*/
    .temp-drag-perview  .temp-item-text__editor { display: none; padding: 12px 20px; background-color: #ffffff; box-shadow: 0px 0px 10px 0px rgba(0, 0, 0, 0.15); border-radius: 8px; position: absolute; left: 50%; top: -74px; transform: translate(-50%); z-index: 10; }
    /*.temp-drag-perview  .temp-resize-able:hover .temp-item-text__editor,*/
    .temp-drag-perview  .temp-resize-able.active .basic-text-editor { display: flex; }
    .temp-drag-perview  .temp-item-text__editor::before { content: ''; width: 0; height: 0; border-left: 8px solid transparent; border-right: 8px solid transparent; border-top: 10px solid #ffffff; position: absolute; left: 50%; bottom: -10px; transform: translate(-50%); }
    .temp-drag-perview  .temp-item-text__editor .el-dropdown { width: 70px; padding-left: 10px; margin-right: 10px; line-height: 28px; border: 1px solid #CCCCCC; border-radius: 4px; }
    ...
    .temp-drag-perview .temp-item-text__editor .temp-item-remove { width: 30px; height: 30px; margin-left: 14px; cursor: pointer; }
    .temp-drag-perview .temp-item-text__editor .temp-item-remove em { font-size: 20px; }
    .temp-drag-perview .temp-item-text__editor .temp-item-bold { width: 30px; height: 30px; margin-right: 15px; background-color: #ffffff; border: 1px solid #CCCCCC; border-radius: 4px; }
    .temp-drag-perview .temp-item-text__editor .temp-item-bold.active,
    .temp-drag-perview .temp-item-text__editor .temp-item-bold:hover { border-color: #409EFF; color: #409EFF; }
    .temp-drag-perview .temp-item-text__editor .temp-item-color { width: 30px; height: 30px; padding: 4px 0; position: relative; }
    .temp-drag-perview .temp-item-text__editor .temp-item-color div.iconfont { line-height: 1; text-align: center; margin-bottom: 2px; font-size: 16px; color: #333333; font-weight: bold; position: relative; }
    .temp-drag-perview .temp-item-text__editor .temp-item-color p { height: 4px; width: 20px; margin: 0 auto; border: 1px solid #CCCCCC; }
    .temp-drag-perview .temp-item-text__editor .temp-item-color div.iconfont::before,
    ...
    .temp-drag-perview .temp-item-text__editor .temp-item-color .el-color-picker { width: 100%; height: 100%; position: absolute; left: 50%; top: 0; transform: translate(-50%); }
    .temp-drag-perview .temp-item-text__editor .temp-child-setting { width: 50px; line-height: 30px; padding-right: 18px; font-size: 14px; position: relative; }
    .temp-drag-perview .temp-item-text__editor .temp-child-setting::before { content: ''; width: 1px; height: 8px; background-color: #CCCCCC; position: absolute; right: 0; top: 50%; transform: translate(0, -50%); cursor: pointer; }
    /*.temp-drag-perview .el-color-picker__trigger { width: 30px; height: 30px; border: none; }*/
    /* .temp-drag-perview .el-color-picker__color { display: none; border: none; }
    .temp-drag-perview .el-color-picker__icon { display: none; border: none; } */
    .temp-drag-perview .temp-item .temp-drag-children { width: 750px !important; min-height: 100%; /*left: 50% !important; transform: translate(-50%);*/ left: 0; }
    .temp-drag-perview .temp-item .temp-drag-children li { height: 100%; }
    /*基础组件拖拽*/
