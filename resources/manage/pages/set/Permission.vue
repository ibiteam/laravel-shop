<template>
    <search-form :model="query" :label-width="100">
        <el-form-item label="名称/权限值" prop="keywords">
            <el-input v-model="query.keywords" clearable placeholder="请输入" />
        </el-form-item>
        <el-form-item>
                ...
                <template v-if="submitForm.icon_type == 1">
                    <el-form-item label-width="150px">
                        ...
                        <div class="ifont_span_show" v-else>
                            ...
                            <el-icon class="icon-img-delete" @click.stop="submitForm.icon = ''">
                                <CircleCloseFilled />
                            </el-icon>
                        </div>
                    </el-form-item>
                ...
                <template v-if="submitForm.icon_type == 2">
                    <el-form-item label-width="150px">
                        <div class="ifont_span_show" v-if="submitForm.icon">
                            <i style="font-size:60px;" class="avatar-uploader-icon iconfont"
                               :class="submitForm.icon"></i>
                            <el-icon class="icon-img-delete" @click.stop="submitForm.icon = ''">
                                <CircleCloseFilled />
                            </el-icon>
                        </div>
                        <div style="border: 1px dashed #d9d9d9;border-radius: 6px;width:100px;height:100px;"
                             v-else></div>
                    </el-form-item>
                    <el-form-item label-width="150px">
                        <div class="iconfont-content s-flex flex-wrap">
                            <div class="iconfont-model" v-for="item in iconList" @click.stop="selectIcon(item)"><i
                                class="iconfont" :class="item"></i></div>
                        </div>
                    </el-form-item>
                </template>
